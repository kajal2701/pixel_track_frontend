...
const Router = [
  ...
  // ── Full layout: all dashboard + NEW admin + order routes ────────────────
  {
    ...
    children: [
      ...
      { path: '/admin/inventory/new', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><InventoryNew /></ProtectedRoute> },
      { path: '/admin/inventory/edit/:id', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><InventoryEdit /></ProtectedRoute> },
      { path: '/admin/production', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><ProductionList /></ProtectedRoute> },
      { path: '/admin/production/new', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><ProductionNew /></ProtectedRoute> },
      { path: '/admin/production/edit/:id', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><ProductionEdit /></ProtectedRoute> },
      ...
      { path: '/admin/reports', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><Reports /></ProtectedRoute> },
      { path: '/admin/users', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><UserList /></ProtectedRoute> },
      { path: '/admin/users/new', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><UserNew /></ProtectedRoute> },
      { path: '/admin/users/edit/:id', element: <ProtectedRoute allowedUserType="admin" allowedRoles={['admin']}><UserEdit /></ProtectedRoute> },
